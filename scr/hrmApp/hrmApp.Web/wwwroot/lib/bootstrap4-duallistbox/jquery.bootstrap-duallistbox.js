...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      btnClass: 'btn-default',                                                  // sets the button style class for all the buttons
      btnMoveText: '&gt;',                                                                // string, sets the text for the "Move" button
      btnRemoveText: '&lt;',                                                              // string, sets the text for the "Remove" button
      btnMoveAllText: 'Összes hozzárendelése',                                                         // string, sets the text for the "Move All" button
      btnRemoveAllText: 'Összes megszüntetése'                                                        // string, sets the text for the "Remove All" button
